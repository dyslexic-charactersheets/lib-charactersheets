...
var Document = /*#__PURE__*/function () {
  ...
  _createClass(Document, [{
    ...
    value: function renderDocument(registry) {
      ...
      var isLoggedIn = this.isLoggedIn; // edit
  ...
  function Character(primary, request, registry) {
    ...
    _this11.promise = new Promise(function (resolve, reject) {
      ready(function () {
        ...
        _this11.data.units = [].concat(_toConsumableArray(_this11.data.units), _toConsumableArray(_this11.getDataUnits(_this11.data.isLoggedIn, _this11.data.isNoCalc)));
