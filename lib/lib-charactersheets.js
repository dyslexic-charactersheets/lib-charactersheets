...
var class_name = {
  ...
  render: function render(args, reg, doc) {
    ...
    return "<div class='class-name'>".concat(preface).concat(name).concat(affix, "</div>");
  }
};
var hr = {
  name: 'hr',
...
var p = {
  ...
  render: function render(args, reg, doc) {
    var cls = elementClass('p', null, args, ['prose'], {
      'align': 'left',
      'size': 'medium'
        ...
        switch (element.type) {
          ...
          case 'slots':
            ...
            if (reg && reg.transform) {
              ...
              var newelements = reg.transform(Object.assign({}, reg.defaults, element), {
                zones: self.zones,
...
function parseCharacter(primary, request) {
  ...
  }, primary.attributes); // if (attr.printHighContrast) {
