...
var field_control_p = {
  ...
  render: function render(args, reg, doc) {
    ...
    var para = "<div class='p'><div class='p__inner'>\n      ".concat(args['with-title'] ? "<div class='p__title p__editpart' contenteditable=\"plaintext-only\">".concat(_e(args.title, doc), "</div>") : '', "\n      <div class='p__body p__editpart' contenteditable=\"plaintext-only\">").concat(_e(args.value, doc), "</div>\n    </div></div>");
    var lines = [];
