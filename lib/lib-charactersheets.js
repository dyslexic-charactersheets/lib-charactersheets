...
function embed(contents) {
  ...
  warn$1("util", "Embed: unknown element!");
  return contents;
}
...
var level_marker = {
  ...
  render: function render(args, reg, doc) {
    ...
    return "<div class='level-marker'>".concat(marker, "<div class='level-marker__level'>").concat(_e(level), "</div></div>");
  }
};
var list = {
  name: 'list',
...
var dl = {
  ...
  render: function render(args, reg, doc) {
    var defs = Object.keys(args.defs).map(function (term) {
      ...
      return "<div><dt>".concat(_e(term), "</dt><dd>").concat(_e(termdef), "</dd></div> ");
    });
