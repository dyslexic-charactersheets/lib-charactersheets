    ...
    function renderTableBasic(headings, rows) {
      ...
      var trows = rows.map(function (row) {
        var cells = row.map(function (cell) {
          var cellCls = elementClass('td', null, cell, [], {
            'align': ''
          });
