...
function trace$1(registry, area, message) {
  var _console4;
  ...
  _createClass(Registry, [{
    ...
    value: function renderItem(item, doc) {
      ...
      if (has(this.registry, item.type)) {
        ...
        this.stack.push(_row2.join(":")); // warn about stray fields
    ...
    value: function addAtZone(zoneId, elements, replace) {
      ...
      try {
        for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
          ...
          if (isNull(_element)) continue;
          if (replace) _element.replace = true;
          this.zones[zoneId].push(_element);
      ...
      function findCalculationFields(element) {
        ...
        if (has(element, "type") && element.type == "field") {
          ...
          if (!has(element, "id") && !has(element, "ref")) {
            trace$1(registry, "Document", "Field with no ID or reference", element);
          }
