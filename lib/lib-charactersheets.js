...
function (_GM_Instance2) {
  ...
  function GM_Maps(primary, request, registry) {
    ...
    _this18 = _possibleConstructorReturn(this, _getPrototypeOf(GM_Maps).call(this, request, registry));
  ...
  _createClass(Request, [{
    ...
    value: function parse(request) {
      ...
      if (has(request, "included")) {
        if (isArray(request.included)) {
          request.included.forEach(function (instance) {
            return _this20.addInstance(instance, false);
          });
        }
      ...
      if (isArray(request.data)) {
        request.data.forEach(function (instance) {
          return _this20.addInstance(instance, true);
        });
      } else {
    ...
    value: function getPrimaries(registry) {
        ...
        if (has(primary, "relationships")) {
          Object.keys(primary.relationships).forEach(function (relkey) {
            primary.attributes[relkey] = primary.relationships[relkey].data.flatMap(function (link) {
              if (has(_this21.instances, link.id)) {
                return [_this21.instances[link.id]];
              } else {
                return [];
              }
      ...
      return primaries.map(function (primary) {
        ...
        switch (primary.type) {
          case 'character':
            return new Character(primary, _this21, registry);

          case 'party':
            return new Party(primary, _this21, registry);

          case 'gm':
            switch (primary.attributes['gm']) {
              case 'characters':
                return new GM_Party(primary, _this21, registry);

              case 'maps':
                return new GM_Maps(primary, _this21, registry);
          ...
          case 'quick':
            switch (primary.attributes['quick']) {
              case 'build':
                return new Build(primary, _this21, registry);
            }
