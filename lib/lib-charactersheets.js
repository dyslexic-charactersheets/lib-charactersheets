    ...
    if (isEmpty$1(args.header) || isEmpty$1(args.contents)) {
      ...
      if (isEmpty$1(args.header)) {
        ...
        if (args.title) {
          ...
          if (isEmpty$1(args.id)) trace("article", "Missing article ID");
          header.push({
            type: 'field',
            id: args.id,
            frame: 'none',
...
function weigh(item) {
  ...
  if (isArray(item)) {
    ...
    var _iterator8 = _createForOfIteratorHelper(item),
        _step8;
...
function fieldInner(args, reg, doc, decoration) {
  ...
  if (args.repeat > 1) {
    ...
    for (var _i9 = 0; _i9 < args.parts.length; _i9++) {
      var _value6 = _i9 >= _values2.length ? null : _values2[_i9];
...
var field_control_speed = {
  ...
  render: function render(args, reg, doc) {
    log("field", "Speed units", doc.measurementUnits); // args.units = doc.measurementUnits
...
var field_control_ref_switch = {
  ...
  render: function render(args) {
    ...
    var menu = "<nav id='ref-switch-field-".concat(args.id, "-menu' class='control-menu'><div>\n      <table><tr>\n        ").concat(switchOptions.map(function (opt) {
  ...
  _createClass(Instance, [{
    ...
    value: function getDataUnits(isLoggedIn, isNoCalc) {
      if (isLoggedIn && !isNoCalc) {
        return ["data/edit", "data/calc", "data/save", "data/search" // "data/note",
        // "data/roll",
        ];
      } else {
        return ["data/no-edit"];
...
var Document = /*#__PURE__*/function () {
  ...
  _createClass(Document, [{
    ...
    value: function getVar(varname) {
      ...
      var _iterator9 = _createForOfIteratorHelper(this.vars[varname]),
          _step9;

      try {
        for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
          var _include = _step9.value;
      ...
      var _iterator10 = _createForOfIteratorHelper(incs),
          _step10;

      try {
        for (_iterator10.s(); !(_step10 = _iterator10.n()).done;) {
          var _include2 = _step10.value;
      ...
      if (is_array) {
        ...
        var _iterator11 = _createForOfIteratorHelper(incs),
            _step11;

        try {
          for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
            var include = _step11.value;
    ...
    value: function addUnit(unit) {
      ...
      if (has(unit, "inc")) {
        var _iterator12 = _createForOfIteratorHelper(unit.inc),
            _step12;

        try {
          for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
            var include = _step12.value;
...
loadSystemData(['common', 'pathfinder2', 'core-fantasy', 'premium']);
