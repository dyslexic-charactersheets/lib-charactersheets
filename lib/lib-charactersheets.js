...
var table = {
  ...
  transform: function transform(args, ctx) {
    ...
    //     let replace = ctx.composeElement(cell, reg); // trust the compose function to call through rows
    //     if (isEmpty(replace)) {
  ...
  _createClass(Document, [{
    ...
    value: function getCalculations() {
      ...
      function findCalculationFields(element) {
        function transformCalculation(id, eq) {
          ...
          return "function (v) { return ".concat(eq, "; }");
        } // fields
    ...
    value: function getJavascript() {
      ...
      function processJS(js) {
        ...
        return template(templateData); // return js; // .replace(/\/\*.*?\*\//g, '');
      }
...
var Character = /*#__PURE__*/function (_Instance) {
  ...
  function Character(primary, request, registry) {
    ...
    _this10.registry = registry;
    _this10.request = request;
    _this10.promise = new Promise(function (resolve, reject) {
      ready(function () {
        _this10.data = parseCharacter(primary, request);
        resolve(_this10.data);
      });
    });
    return _this10;
  }
...
var GM_Instance = /*#__PURE__*/function (_Instance3) {
  ...
  _createClass(GM_Instance, [{
    ...
    value: function render() {
      ...
      var data = this.data;
      return new Promise(function (resolve, reject) {
        log("GM", "Units: ".concat(_this15.data.units));
        ready(function () {
          try {
            var system = getSystem(data.game);
...
var GM_Party = /*#__PURE__*/function (_GM_Instance) {
  ...
  function GM_Party(primary, request, registry) {
    ...
    _this16 = _super4.call(this, request, registry);
    _this16.data = parseGM_Party(primary, request);

    _this16.parseGM_Instance(primary, request);
...
var GM_Maps = /*#__PURE__*/function (_GM_Instance2) {
  ...
  function GM_Maps(primary, request, registry) {
    ...
    _this17 = _super5.call(this, request, registry);
    _this17.data = parseGM_Maps(primary, request);
        ...
        switch (primary.type) {
          ...
          case 'gm':
            switch (primary.attributes['gm']) {
              ...
              case 'maps':
                return new GM_Maps(primary, _this20, registry);
