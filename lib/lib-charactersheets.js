  ...
  transform: function transform(args, ctx) {
    if (isEmpty(args.header) || isEmpty(args.contents)) {
      ...
      if (args.action && !args.left) {
        args.left = {
          type: 'icon',
          icon: args.action == 1 ? 'action' : 'action' + args.action
...
var calc = {
  ...
  render: function render(args, reg, doc) {
    ...
    args.calc = true;
    var cls = elementClass('row', null, args, ["calc", "inline", "pad"], {
      'layout': 'center',
      'lp': '',
      'rb': ''
...
var dl = {
  ...
  render: function render(args, reg, doc) {
    var defs = Object.keys(args.defs).map(function (term) {
      ...
      return "<div><dt>".concat(icon).concat(_e(term), "</dt><dd>").concat(_e(termdef), "</dd></div> ");
    });
...
function renderHeading(h) {
  return function (args, reg, doc) {
    ...
    return "<".concat(h).concat(cls, ">").concat(_e(args.title), "</").concat(h, ">");
  };
}
...
var class_name = {
  ...
  render: function render(args, reg, doc) {
    var preface = isEmpty(args.preface) ? '' : "<h5>".concat(_e(args.preface), "</h5>");
    var name = "<h2>".concat(_e(args.title), "</h2>");
    var suffix = isEmpty(args.suffix) ? '' : "<h5>".concat(_e(args.suffix), "</h5>");
...
var hr = {
  ...
  render: function render(args) {
    var cls = elementClass('hr', null, args, ['swash', 'light']);
...
var icon = {
  ...
  render: function render(args) {
    var cls = elementClass('icon', null, args, [], {
      "icon": "",
      "size": "medium"
    });
...
var label = {
  ...
  render: function render(args, reg, doc) {
    ...
    return "<label".concat(cls, ">").concat(_e(args.label), "</label>");
  }
};
var layout = {
  name: 'layout',
...
var level_marker = {
  ...
  render: function render(args, reg, doc) {
    ...
    var cls = elementClass("level-marker", null, args, ['inline']);
    var marker = args.marker ? "<label>".concat(_e(args.marker), "</label>") : '';
    return "<div".concat(cls, ">").concat(marker, "<div class='level-marker__level'>").concat(_e(level), "</div></div>");
  }
};
var list = {
  name: 'list',
...
var p = {
  ...
  render: function render(args, reg, doc) {
    ...
    return "<p".concat(cls, ">").concat(icon).concat(_e(args.content), "</p>");
  }
};
var portrait = {
  name: 'portrait',
...
var ruby = {
  ...
  render: function render(args, reg, doc) {
    ...
    return "<div".concat(cls, "><label class='ruby__text'>").concat(_e(args.ruby), "</label>").concat(reg.render(args.contents, doc), "</div>");
  }
};
var ruby_round_down = {
...
var section = {
  ...
  render: function render(args, reg, doc) {
    ...
    var title = args.untitled ? '' : "<h3>".concat(_e(args.title), "</h3>");
...
var span = {
  ...
  render: function render(args, reg, doc) {
    ...
    return "<span".concat(cls, ">").concat(_e(args.content), "</span>");
  }
};
...
function defaultFrameRender(args, reg, doc) {
  ...
  var label = args.label ? "<label".concat(ident.for, ">").concat(_e(args.label), "</label>") : '';
  var legend = args.legend ? "<legend>".concat(_e(args.legend), "</legend>") : '';
...
var field_frame_h_label = {
  ...
  render: function render(args, reg, doc) {
    ...
    var label = args.label ? "<label class='field__h-label'".concat(ident.for, ">").concat(_e(args.label), "</label>") : ''; // WRONG! The h-label is supposed to go inside the box!
...
var field_frame_annotation = {
  ...
  render: function render(args, reg, doc) {
    var ident = fieldIdent(args.id);
    var label = args.label ? "<label class='field__annotation'".concat(ident.for, ">").concat(_e(args.label), "</label>") : '';
    return "".concat(label).concat(fieldInner(args, reg, doc));
  }
};
...
var field_control_value = {
  ...
  render: function render(args, reg, doc) {
    ...
    var suffix = args.suffix ? "<span class='field__overlay'>".concat(__(args.suffix), "</span>") : '';
    var underlay = args.underlay ? "<u>".concat(__(args.underlay), "</u>") : '';
    var value = "<span>".concat(_e(args.value), "</span>");
      ...
      ready(function () {
        try {
          var _ret = function () {
            ...
            if (system === null) {
              error("Character", "System not found:", _this9.data.game);
              return {
                v: void 0
              };
