...
var repeat = {
  ...
  transform: function transform(args, ctx) {
    ...
    var end = args.start + repeat;

    for (var i = args.start; i < end; i++) {
      var vars = {};
