...
function adjustColour(c, documentColour, intensity, highContrast) {
  try {
    ...
    log("util", "adjustColour: lightness = ".concat(lightness, ", intensity = ").concat(intensity));
    ...
    if (lightness < 98) {
      ...
      log("util", "adjustColour: Adjusting intensity: lightness = ".concat(lightness, ", intensity = ").concat(intensity));
    }
