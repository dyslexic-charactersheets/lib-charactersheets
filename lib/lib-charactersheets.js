...
var ifelem = {
  ...
  transform: function transform(args, ctx) {
    ...
    var condition = interpolate(args.condition, {}, ctx);
    ...
    if (m = condition.match(/(.*)==(.*)/)) {
      ...
      var _right2 = trim(m[2]);

      condition = _left2 >= _right2;
    } else if (m = condition.match(/(.*)>(.*)/)) {
      var _left3 = trim(m[1]);

      var _right3 = trim(m[2]);

      condition = _left3 > _right3;
    } else if (m = condition.match(/(.*)<=(.*)/)) {
      var _left4 = trim(m[1]);

      var _right4 = trim(m[2]);

      condition = _left4 <= _right4;
    } else if (m = condition.match(/(.*)<(.*)/)) {
      var _left5 = trim(m[1]);

      var _right5 = trim(m[2]);
...
var p = {
  ...
  render: function render(args, reg, doc) {
    ...
    return "<p".concat(cls, ">").concat(icon).concat(title).concat(_e(content, doc), "</p>");
  }
};
var portrait = {
  name: 'portrait',
...
function fieldInner(args, reg, doc, decoration) {
  ...
  if (args.repeat > 1) {
    ...
    for (var _i6 = 0; _i6 < args.parts.length; _i6++) {
      var _value = _i6 >= _values.length ? null : _values[_i6];
  ...
  _createClass(Document, [{
    ...
    value: function composeDocument(registry) {
      ...
      function compose(element) {
        ...
        for (var _i7 = 0, _arr2 = ["contents", "placeholder", "header", "inputs"]; _i7 < _arr2.length; _i7++) {
    ...
    value: function getStylesheet() {
      ...
      this.units.forEach(function (unit) {
        ...
        if (unit.id != "document") rendered = replaceColours(rendered, _this6.printColour, _this6.accentColour, _this6.printIntensity, _this6.highContrast);
...
function (_Instance) {
  ...
  function Character(primary, request, registry) {
    ...
    _this7 = _possibleConstructorReturn(this, _getPrototypeOf(Character).call(this));
    _this7.registry = registry;
    _this7.request = request;
    _this7.data = parseCharacter(primary, request);
    _this7.loadQueue = new LoadQueue();
    return _this7;
  }
...
function (_Instance2) {
  ...
  function Party(primary, request, registry) {
    ...
    _this9 = _possibleConstructorReturn(this, _getPrototypeOf(Party).call(this));
    _this9.registry = registry;
    _this9.data = parseParty(primary);
    var characterDefaults = {
      game: _this9.data.game,
      language: _this9.data.language
    };
    _this9.members = _this9.data.members.map(function (chardesc) {
  ...
  _createClass(Party, [{
    ...
    value: function render() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this10.members.forEach(function (member) {
