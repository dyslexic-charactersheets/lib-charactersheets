...
var GM_Instance = /*#__PURE__*/function (_Instance3) {
  ...
  _createClass(GM_Instance, [{
    ...
    value: function render() {
      ...
      var data = this.data;
      return new Promise(function (resolve, reject) {
        log("GM", "Units: ".concat(_this17.data.units));
        ready(function () {
          try {
            var system = getSystem(data.game);
...
var GM_Party = /*#__PURE__*/function (_GM_Instance) {
  ...
  function GM_Party(primary, request, registry) {
    ...
    _this18 = _super4.call(this, request, registry);
    _this18.data = parseGM_Party(primary, request);
...
var GM_Maps = /*#__PURE__*/function (_GM_Instance2) {
  ...
  function GM_Maps(primary, request, registry) {
    ...
    _this19 = _super5.call(this, request, registry);
    _this19.data = parseGM_Maps(primary, request);

    _this19.parseGM_Instance(primary, request);
  ...
  _createClass(Build, [{
    ...
    value: function render() {
      ...
      return new Promise(function (resolve, reject) {
        ready(function () {
          try {
            log("Build", "Data", _this20.data);
            var system = getSystem(_this20.data.game);
            var documentUnit = system.getUnit("document");
            var document = new Document(documentUnit);
            document.language = _this20.data.language;
            var units = system.getUnits(_this20.data.units);
            ...
            document.composeDocument(_this20.registry);
            document.title = "Build a character"; // log("Build", "Document", document);
            // render the document

            var data = document.renderDocument(_this20.registry);
            resolve({
              data: data,
              filename: document.title + ".html",
              mimeType: "text/html"
...
var Custom = /*#__PURE__*/function (_Instance4) {
  ...
  function Custom(primary, request, registry) {
    ...
    _this21.registry = registry;
    _this21.request = request;
    _this21.promise = new Promise(function (resolve, reject) {
      ready(function () {
        _this21.request = request;
        _this21.data = parseCustom(primary);
        resolve(_this21.data);
      });
    });
    return _this21;
  }
  ...
  _createClass(Custom, [{
    ...
    value: function render() {
      ...
      return new Promise(function (resolve, reject) {
        promise.then(function (data) {
          log("Custom", "Units: ".concat(_this22.data.units));
          ready(function () {
            try {
              ...
              var documentUnit = system.getUnit("document");
              var document = new Document(documentUnit, data.id);
              document.request = _this22.request; // language
  ...
  _createClass(Request, [{
    ...
    value: function parse(request) {
      ...
      if (has(request, "included")) {
        if (isArray(request.included)) {
          request.included.forEach(function (instance) {
            return _this23.addInstance(instance, false);
          });
        }
      ...
      if (isArray(request.data)) {
        request.data.forEach(function (instance) {
          return _this23.addInstance(instance, true);
        });
      } else {
    ...
    value: function getPrimaries(registry) {
        ...
        if (has(primary, "relationships")) {
          Object.keys(primary.relationships).forEach(function (relkey) {
            primary.attributes[relkey] = primary.relationships[relkey].data.flatMap(function (link) {
              if (has(_this24.instances, link.id)) {
                return [_this24.instances[link.id]];
              } else {
                return [];
              }
      ...
      return primaries.map(function (primary) {
        ...
        switch (primary.type) {
          case 'character':
            return new Character(primary, _this24, registry);

          case 'party':
            return new Party(primary, _this24, registry);

          case 'gm':
            switch (primary.attributes['gm']) {
              case 'characters':
                return new GM_Party(primary, _this24, registry);

              case 'maps':
                return new GM_Maps(primary, _this24, registry);
          ...
          case 'quick':
            switch (primary.attributes['quick']) {
              case 'build':
                return new Build(primary, _this24, registry);
            }

          case 'custom':
            return new Custom(primary, _this24, registry);
