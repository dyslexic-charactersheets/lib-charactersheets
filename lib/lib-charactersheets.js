...
var li = {
  ...
  render: function render(args, reg, doc) {
    return "<li>".concat(esc(__(args.content), true), "</li>");
  }
};
var dl = {
  name: 'dl',
