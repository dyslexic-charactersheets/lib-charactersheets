...
function parseCharacter(chardesc) {
  ...
  }, chardesc.attributes); // an object to start with
...
function () {
  ...
  _createClass(Character, [{
    ...
    value: function render(callback) {
      ...
      var self = this;
      log$1("Character", "Render character");
      ...
      ready(function () {
        try {
          ...
          for (var i = 0; more && i < 10; i++) {
            more = false;
            log$1("Character", "Checking for required units");
            var moreunits = [];
          ...
          loadQueue.ready(function () {
            ...
            fs$1.writeFile(__dirname + '/../test/out/test.json', JSON.stringify(document.doc, null, 2), function (err) {
