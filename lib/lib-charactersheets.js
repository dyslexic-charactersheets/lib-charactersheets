            ...
            if (has(element, "contents")) {
              element.contents = element.contents.flatMap(function (subelement) {
                if (subelement.type == "reduce") {
                  ...
                  log("Document", "Reducing slots", subelement.reduce, "min = ".concat(element.min, ", max = ").concat(element.max));
                  element.min -= reduce;
                  log("Document", "min = ".concat(element.min, ", max = ").concat(element.max));
                  return [];
                }
